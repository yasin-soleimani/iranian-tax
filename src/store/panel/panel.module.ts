...
const INITIAL_panel: PanelState = {
  ...
  moadianInvoiceHeader: {
    ...
    sbc: null, //كد شعبه فروشنده
    bpc: null, // كد پستی خریدار
    bbc: null, // كد شعبه خریدار
    ft: null, // نوع پرواز
    bpn: null, // شماره گذرنامه خریدار
    scln: "0", // شماره پروانه گمركی
    cdcd: null, // تاریخ کوتاژ
    cdcn: "0", // شماره کوتاژ
    scc: null, // كد گمرک محل اظهار
    ...
    torv: null, // مجموع ارزش ریالی
    tocv: null, // مجموع ارزش ارزی
    setm: "1", // روش تسویه
